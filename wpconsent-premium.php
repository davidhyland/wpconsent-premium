...
class WPConsent_Premium {
	 ...
	 * @since 1.0.0
	 *
	 * @var WPConsent_Premium The one true WPConsent_Premium
	 */
	 ...
	 *
	 * @var WPConsent_Multilanguage
	 */
	public $multilanguage;

	/**
	 * The services library instance.
	 *
	 * @var WPConsent_Services_Library
	 */
	public $services_library;

	/**
	 * The Addons instance.
	 *
	 * @var WPConsent_Addons_Pro
	 */
	public $addons;
	...
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof WPConsent_Premium ) ) {
			self::$instance = new WPConsent_Premium();
		}
	...
	private function includes() {
		...
		require_once WPCONSENT_PLUGIN_PATH . 'includes/pro/loader.php';
		// Load compatibility.
	...
	public function load_components() {
		...
		$this->script_blocker = new WPConsent_Script_Blocker_Pro();
		// Load the cookie blocking functionality.
		$this->cookie_blocking = new WPConsent_Cookie_Blocking();
		// Load the ip helpers.
		$this->ip = new WPConsent_IP();
		// Load the geolocation functionality.
		$this->geolocation = new WPConsent_Geolocation();
		// Load the consent logging endpoint.
		$this->consent_log = new WPConsent_Consent_Log();

		// Load the consent logging endpoint.
		new WPConsent_Consent_Log();
		// Load the automatic scanner.
...
require_once __DIR__ . '/includes/wpconsent-premium.php';
